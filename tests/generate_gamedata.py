"""Regenerate the committed gamedata name tables from an installed game.

Builds data/gamedata.json and the site copy ts/site/public/gamedata.json
from the local BG3 install (auto-detected, or BG3_DATA_DIR). Run after a
game patch or whenever bg3parser/gamedata.py learns a new table:
